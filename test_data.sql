...
INSERT INTO company_group (group_name, group_alias, contact_mail)
VALUES ('Test group', 'test', 'test@mail.com');

-- DATOS DE company
INSERT INTO company (id_group, comp_name, comp_alias)
...
INSERT INTO simple_loan (id_comp, loan_num, loan_alias, currency, loan_amount, int_type, int_rate, months_term, financial_entity,loan_type, date_start,date_end)
...
INSERT INTO revolver_credit (id_comp, credit_num, credit_alias, currency, credit_limit, int_type, int_rate, months_term, financial_entity, date_start, date_end)
...
INSERT INTO credit_card (id_comp, card_num, card_alias, currency, credit_limit, int_rate, closing_date, payment_due_date, expiration_date, anual_fee_ammount, anual_fee_date, financial_entity)
